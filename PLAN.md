...
| `MUSIC_PATH`          | `/music`     | Mount point of the music share — safety boundary, no deletes outside this path |
| `BEETS_LIBRARY_PATH`  | *(optional)* | Beets library root. Set if beets returns relative paths (e.g. /music/clean)    |
